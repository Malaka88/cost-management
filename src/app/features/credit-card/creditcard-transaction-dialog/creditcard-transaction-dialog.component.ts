...
@Component({
  selector: 'app-creditcard-transaction-dialog',
  templateUrl: './creditcard-transaction-dialog.component.html',
  styleUrls: ['./creditcard-transaction-dialog.component.css']
})
export class CreditcardTransactionDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CreditcardTransactionDialogComponent>,
