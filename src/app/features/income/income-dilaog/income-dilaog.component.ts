...
@Component({
  selector: 'app-income-dilaog',
  templateUrl: './income-dilaog.component.html',
  styleUrls: ['./income-dilaog.component.css']
})
export class IncomeDilaogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<IncomeDilaogComponent>,
